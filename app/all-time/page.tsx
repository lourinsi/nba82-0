...
const ROSTER_ACCOLADE_SORT_LABELS: Partial<Record<string, string>> = {
  ...
  "aba-mvp": "ABA MVPs",
  fmvp: "FMVPs",
  "aba-playoffs-mvp": "ABA Playoff MVPs",
  "retro-fmvp": "Retro FMVPs",
  "all-nba": "All NBA",
  "aba-all-league": "All ABA",
  scoring: "Scoring Titles",
  "aba-scoring": "ABA Scoring Titles",
  assists: "Assist Titles",
  "aba-assists": "ABA Assist Titles",
  rebounds: "Rebound Titles",
  "aba-rebounds": "ABA Rebound Titles",
  "three-point-title": "3PT Titles",
  rings: "Rings",
  "aba-champ": "ABA Champs",
  dpoy: "DPOYs",
  ...
  "aba-all-star-mvp": "ABA AS MVPs",
  "three-point-contest": "3PT Contest",
  "all-star": "All-Stars",
  "aba-all-star": "ABA All-Stars",
  "sixth-man": "6MOYs",
  "most-improved": "MIPs",
  roy: "ROYs",
  "aba-roy": "ABA ROYs",
