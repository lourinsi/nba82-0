...
const ACCOLADE_FIELDS: AccoladeField[] = [
  ...
  { key: "aba_mvp_count", label: "ABA MVP", countDefault: 0, maxCount: 5, weightMax: 16 },
  { key: "finals_mvp_count", label: "Finals MVP", countDefault: 1, maxCount: 8, weightMax: 16 },
  { key: "aba_playoffs_mvp_count", label: "ABA Playoff MVP", countDefault: 0, maxCount: 5, weightMax: 12 },
  ...
  { key: "aba_all_league_1st", label: "All-ABA 1st", countDefault: 0, maxCount: 8, weightMax: 14 },
  { key: "aba_all_league_2nd", label: "All-ABA 2nd", countDefault: 0, maxCount: 8, weightMax: 12 },
  { key: "championship_rings", label: "Rings", countDefault: 1, maxCount: 12, weightMax: 8 },
  { key: "aba_championship_rings", label: "ABA Champ", countDefault: 0, maxCount: 6, weightMax: 8 },
  ...
  { key: "aba_all_def_1st", label: "ABA All-Defense 1st", countDefault: 0, maxCount: 8, weightMax: 6 },
  { key: "aba_all_def_2nd", label: "ABA All-Defense 2nd", countDefault: 0, maxCount: 8, weightMax: 6 },
  ...
  { key: "aba_scoring_titles", label: "ABA Scoring Titles", countDefault: 0, maxCount: 8, weightMax: 7 },
  { key: "aba_assist_titles", label: "ABA Assist Titles", countDefault: 0, maxCount: 8, weightMax: 7 },
  { key: "aba_rebound_titles", label: "ABA Rebound Titles", countDefault: 0, maxCount: 8, weightMax: 6 },
  { key: "three_point_titles", label: "3PT Titles", countDefault: 0, maxCount: 12, weightMax: 7 },
  ...
  { key: "aba_all_star_mvp_count", label: "ABA AS MVP", countDefault: 0, maxCount: 5, weightMax: 5 },
  { key: "three_point_contest_wins", label: "3PT Contest", countDefault: 0, maxCount: 5, weightMax: 5 },
  { key: "all_star_selections", label: "All-Star Selections", countDefault: 7, maxCount: 25, weightMax: 5 },
  { key: "aba_all_star_selections", label: "ABA All-Stars", countDefault: 0, maxCount: 10, weightMax: 5 },
  ...
  { key: "aba_rookie_of_year_count", label: "ABA ROY", countDefault: 0, maxCount: 1, weightMax: 5 },
